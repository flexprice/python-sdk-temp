...
def main():
    ...
    events_api_instance = EventsApi(api_client)
    ...
    for i in range(5):
        ...
        events_api_instance.events_post_async(event, callback=on_event_processed)
    ...
    events_api_instance.events_post_async(forget_event)
