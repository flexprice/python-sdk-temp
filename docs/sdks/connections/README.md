...
with FlexPrice(
    ...
    res = flex_price.connections.post_connections_search(request={})
...
with FlexPrice(
    ...
    res = flex_price.connections.put_connections_id_(id="<id>", body=components.DtoUpdateConnectionRequest())
